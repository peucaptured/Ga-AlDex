...
# ================================
# MOVES (MoveDB + Move Creator) - agora modularizado
# ================================
from ga_aldex.moves_bundle import *
# ================================
# FIREBASE - agora modularizado
# ================================
...
# ==========================================
# 🎨 ESTILO VISUAL GLOBAL (POKÉMON RETRÔ) - agora modularizado
# ==========================================
from ga_aldex.ui_styles import apply_global_styles
apply_global_styles()
...
if page == "Pokédex (Busca)":
    from ga_aldex.dex_ui import render_pokedex_busca_page
    render_pokedex_busca_page(
        df=df,
        user_data=user_data,
...
# PVP ARENA
    ...
    from ga_aldex.arena import render_pvp_arena_page
    render_pvp_arena_page(
        trainer_name=trainer_name,
        user_data=user_data,
        df=df,
    )
