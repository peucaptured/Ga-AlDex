...
def render_compendium_page() -> None:
    ...
    if st.session_state["comp_view"] == "home":
        # Tela inicial (igual ao app 35): HTML puro + clique direto nas opções (sem botão ENTER)
        try:
            from st_click_detector import click_detector
        except ImportError:
            st.error("Biblioteca não instalada. Adicione 'st-click-detector' ao requirements.txt e reinicie o app.")
        ...
        <style>
          .ds-home-title{
            ...
            letter-spacing: 6px;
            margin: 0 0 46px 0;
            text-shadow: 0 0 15px rgba(212, 175, 55, 0.60);
          }
          .ds-menu-container{
            display:flex;
            flex-direction:column;
        ...
        <div class="ds-home">
          <div class="ds-home-panel">
            <div class="ds-home-title">BEM VINDO A GA'AL</div>
        ...
        clicked = click_detector(html_home)
