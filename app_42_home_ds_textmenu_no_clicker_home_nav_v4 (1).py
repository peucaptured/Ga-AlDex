...
def render_compendium_page() -> None:
    ...
    /* Dentro do painel, centraliza o menu (estilo Dark Souls: texto em coluna) */
    .ds-home-panel .ds-home-menu {{
        display: flex;
        flex-direction: column;
        align-items: center;
        gap: 18px;
    ...
    # =========================================================
    if st.session_state["comp_view"] == "home":
        # Tela inicial (HTML puro) — visual Dark Souls e navegação via ?cv=...
        home_html = """
        <div class='ds-home'>
          <div class='ds-home-panel'>
            <div class='ds-title'>BEM VINDO A GA'AL</div>
            <div class='ds-home-menu'>
              <a class='ds-menu-item' href='?cv=npcs'>❖  NPCs  ❖</a>
              <a class='ds-menu-item' href='?cv=ginasios'>❖  Ginásios  ❖</a>
              <a class='ds-menu-item' href='?cv=locais'>❖  Locais  ❖</a>
              <a class='ds-menu-item' href='?cv=sair'>❖  Sair  ❖</a>
            </div>
          </div>
        </div>
        """
